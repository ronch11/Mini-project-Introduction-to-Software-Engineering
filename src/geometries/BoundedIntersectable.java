...
public interface BoundedIntersectable extends Intersectable {
    /**
    ...
    abstract List<GeoPoint> calculateGeoIntersection(Ray ray);

    @Override
    public default List<GeoPoint> findGeoIntersections(Ray ray) {
        return isRayIntersectingAABB(ray) ? calculateGeoIntersection(ray) : null;
    }
}
