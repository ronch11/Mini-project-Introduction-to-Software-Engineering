...
public class TriangleTests {
    ...
    public void testFindIntersections() {
        ...
        assertEquals("TC01: Wrong values in the intersection point.", List.of(new Point3D(2, 2.8, 2)), actualValue);
        ...
        assertEquals("TC04: Wrong values in the intersection point.", List.of(new Point3D(2.5, 4, 3.5)), actualValue);
