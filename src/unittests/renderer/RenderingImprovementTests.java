...
public class RenderingImprovementTests {
    ...
    public void simpleSoftShadows() {
        ...
        RenderBase render = new MultiThreadsRender() //
                .setDebugPrint().setMultithreading(3).setImageWriter(new ImageWriter("soft shadows simple", 600, 600)) //
                .setCamera(camera) //
    ...
    public void SoftShadowsBVH() {
        ...
        RenderBase render = new MultiThreadsRender() //
                .setDebugPrint().setMultithreading(3).setImageWriter(new ImageWriter("soft shadows BVH", 600, 600)) //
                .setCamera(camera) //
                .setRayTracer(new RayTracerBeams(scene).setNumOfRays(500));
        render.renderImage();
        render.writeToImage();
