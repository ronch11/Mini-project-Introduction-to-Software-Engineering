...
public class SphereTests {
    ...
    public void testFindIntersections() {
        ...
        Vector xAxisNegativeDir = xAxisPositiveDir.scale(-1d); // unit vector in the negative x axis for creating Rays.
        ...
        Point3D p4 = new Point3D(1.95916630466, 0.2, 0.2); // for EP TC03
        Point3D p5 = new Point3D(0.5, 0.5, 0.70710678118); // for BVA TC11 and TC12 and EP TC04
        Point3D p6 = new Point3D(1.5, 0.5, 0.70710678118); // for BVA TC11
        ...
        Point3D p10 = new Point3D(1, 0, 1); // optimize code create the point only once for BVA TC19, TC20 and TC21
        // ============ Equivalence Partitions Tests ==============

        // TC01: Ray's line is outside the sphere (0 points)
        assertNull("Ray's line out of sphere", sphere.findIntersections(new Ray(p0, new Vector(1, 1, 0))));
        ...
        assertNull("TC12: Number of Intersection Points should be null.",
                sphere.findIntersections(new Ray(p9, xAxisNegativeDir)));
